...
function strengthInfo(pass) {
  if (!pass)               return null;
  if (pass.length < 6)     return { label: "Too short", w: "w-1/5",  bar: "bg-red-500",    text: "text-red-500"    };
  if (pass.length < 8)     return { label: "Weak",      w: "w-2/5",  bar: "bg-orange-400", text: "text-orange-500" };
  if (!/[0-9]/.test(pass)) return { label: "Medium",    w: "w-3/5",  bar: "bg-yellow-400", text: "text-yellow-600" };
  if (!/[A-Z]/.test(pass)) return { label: "Good",      w: "w-4/5",  bar: "bg-green-400",  text: "text-green-600"  };
  return                          { label: "Strong",     w: "w-full", bar: "bg-brand-600",  text: "text-brand-600"  };
}
    ...
    <div className="min-h-screen flex flex-col lg:flex-row
      ...
      <div className="hidden lg:flex lg:w-1/2
        ...
        <p className="text-blue-200 text-lg leading-relaxed max-w-sm">
          Every new account includes 1 GB free storage and 1,000
          free API calls per month — no credit card needed.
        </p>
      ...
      <div className="flex-1 lg:w-1/2 flex items-center justify-center
        ...
        <div className="w-full max-w-sm lg:max-w-md">
          ...
          <div className="bg-white rounded-3xl shadow-2xl w-full p-6 sm:p-8 lg:p-10">
            ...
            {success && (
              <div className="flex items-start gap-2.5 bg-green-50 border border-green-200
